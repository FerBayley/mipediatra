...
class Atrivia10 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Para desinflamar y aliviar el prurito causado por picaduras, es mejor aplicar:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Aadd10')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Compresas frías</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Compresas calientes</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Agua oxigenada</Text>
                        </Button>
                    </View>
                </Content>
