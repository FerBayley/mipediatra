...
class Atrivia16 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        El tiempo de vida promedio de un mosquito es de:
                        </Text>
                    </View>
                        ...
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('AaddError5')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>10-12 meses</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('AaddError5')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert( 
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('Aadd16')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>10-30 días</Text>
                        </Button>
                    </View>
                </Content>
