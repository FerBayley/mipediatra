...
class Atrivia23 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        En las picaduras de insectos, el agente irritante del insecto es:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            >
                            <Text style={styles.blanco}>La saliva</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>La materia fecal</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>La orina</Text>
                        </Button>
                    </View>
                </Content>
