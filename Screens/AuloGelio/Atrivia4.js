...
class Atrivia4 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Pulgas, jejenes y tábanos</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Moscas, mosquitos, bichos colorados</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Aadd4')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
