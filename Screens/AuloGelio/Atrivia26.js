...
class Atrivia26 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Los insecticidas ambientales nunca deben aplicarse:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            >
                            <Text style={styles.blanco}>Para uso personal</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>En ambientes cerrados</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Ambas precauciones</Text>
                        </Button>
                    </View>
                </Content>
