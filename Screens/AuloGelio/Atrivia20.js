...
class Atrivia20 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        AULO GELIO Loción debe aplicarse en el cuerpo de los niños:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Aadd20')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Con las manos del adulto</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Con el spray</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Con las manos del niño</Text>
                        </Button>
                    </View>
                </Content>
