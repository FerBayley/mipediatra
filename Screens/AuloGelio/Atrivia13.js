...
class Atrivia13 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Las molestias causadas por picaduras de insectos puede durar hasta:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            >
                            <Text style={styles.blanco}>1 día</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert( 
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('Aadd13')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>7 días</Text>
                        </Button>
                    </View>
                </Content>
