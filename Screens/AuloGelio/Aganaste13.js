...
class Aganaste13 extends Component {    
    ...
    render() {
        ...
        const uri = '../../assets/images/aulo-ganaste.png';
           ...
           <Content  showsVerticalScrollIndicator={false}>
               ...
               <View style={styles.container}>
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                        <BlurView>
                            <Image style={{ width: 250, height: 194 }}
                            source={require( uri )} />
                        </BlurView>
                    </View>

                    <Button block style={ styles.botonSegui }
                        onPress={() => this.props.navigation.navigate('AuloBrand13')}
                    >
