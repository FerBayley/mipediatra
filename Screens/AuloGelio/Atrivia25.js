...
class Atrivia25 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Los momentos del día en los que los mosquitos pican con mayor frecuencia son:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            >
                            <Text style={styles.blanco}>El amanecer, atardecer y noche</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>El mediodía</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>La mañana y la tarde</Text>
                        </Button>
                    </View>
                </Content>
