...
class Atrivia2 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            AULO GELIO es un repelente a base de:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Aadd2')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                        ...
                        >
                            <Text style={styles.blanco}>Insecticidas</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>N,N-Dietil-meta-toluamida</Text>
                        </Button>
                    </View>
                </Content>
