...
class Atrivia15 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            >
                            <Text style={styles.blanco}>Comida humana, comida de los animales</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Cadáveres de animales, basuras y excrementos</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert( 
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('Aadd15')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>Todo lo anterior</Text>
                        </Button>
                    </View>
                </Content>
