...
class Atrivia24 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La principal manera de combatir al dengue en el ámbito hogareño es:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            >
                            <Text style={styles.blanco}>Fumigar</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Descacharrar</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Esperar el invierno</Text>
                        </Button>
                    </View>
                </Content>
