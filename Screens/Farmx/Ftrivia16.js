...
class Ftrivia16 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La piel de un bebé respecto a la del adulto es:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd16')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Un 20-30% más delgada</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Un 40-50% más delgada</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Un 10-20% más delgada</Text>
                        </Button>
                    </View>
                </Content>
