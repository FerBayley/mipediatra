...
class Ftrivia12 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            FARM-X CREMA está indicado para heridas leves porque:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd12')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Repara y cicatriza la piel</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Se absorve rápidamente</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Contiene analgésicos</Text>
                        </Button>
                    </View>
                </Content>
