...
class Ftrivia13 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Los primeros auxilios ante una quemadura consisten en:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd13')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Sumergir la zona en agua fría</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Aplicar hielo</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Lavar con agua y jabón</Text>
                        </Button>
                    </View>
                </Content>
