...
class Ftrivia2 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            FARM-X CREMA alivia molestias de la piel irritada como:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            {/* Respuesta Correcta*/}
                            <Text style={styles.blanco}>Picazón</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Ardor</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd2')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
