...
class Ftrivia3 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            La dermatitis de pañal se clasifica como el tipo:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Atópica</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Seborréica</Text>
                        </Button>
                    </View>
                </Content>
