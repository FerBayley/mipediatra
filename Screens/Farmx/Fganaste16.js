...
class Fganaste16 extends Component {    
    ...
    render() {
        ...
        const premioFarmx = '../../assets/images/premio-farm.png';
           ...
           <Content  showsVerticalScrollIndicator={false}>
               ...
               <View style={styles.container2}>
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <BlurView>
                            <Image style={{ width: 252, height: 219 }}
                            source={require( premioFarmx )} />
                        </BlurView>
                    </View>

                    <Button block style={ styles.botonSegui }
                        onPress={() => this.props.navigation.navigate('FarmBrand16')}
                    >
