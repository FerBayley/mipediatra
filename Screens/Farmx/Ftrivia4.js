...
class Ftrivia4 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            FARM-X CREMA es reepitelizante porque:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            >
                            <Text style={styles.blanco}>Contiene epítetos</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Es hidratante</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd4')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
