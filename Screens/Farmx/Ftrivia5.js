...
class Ftrivia5 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            FARM-X CREMA está indicada para heridas:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('FaddError2')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            {/* Respuesta Correcta*/}
                            <Text style={styles.blanco}>Post-quirúrgicas</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Quemaduras, escaras y dermatitis</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd5')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
