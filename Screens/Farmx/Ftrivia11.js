...
class Ftrivia11 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La piel de los bebés es más sensible a ciertos productos, y debe evitarse:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd11')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>El uso de productos con alcohol o fragancias</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>El óleo calcáreo</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>La higiene periódica</Text>
                        </Button>
                    </View>
                </Content>
