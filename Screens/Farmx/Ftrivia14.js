...
class Ftrivia14 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd14')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Cicatrizante, reparadora, antiinflamatoria, antimicrobiana</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Cicatrizante, reductora, antiinflamatoria, antimicótica</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Cicatrizante, reparadora, antiinflamatoria, antimicótica</Text>
                        </Button>
                    </View>
                </Content>
