...
class Ftrivia26 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La dermatitis de contacto tambien puede ser causada por:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Fadd26')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Fricción de las prendas o pañal</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Infecciones</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Inmadurez de la piel</Text>
                        </Button>
                    </View>
                </Content>
