...
class LiliTrivia13 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Se llama "alimentos energéticos" a los que aportan principalmente:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Proteínas</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('LiliAdd13')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Hidratos de Carbono y Grasas</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Calorías vacías</Text>
                        </Button>
                    </View>
                </Content>
