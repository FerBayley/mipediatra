...
class LiliTrivia6 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La parte del brócoli habitualmente usada como comestible es:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>El bulbo</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('LiliAdd6')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>La flor</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Las hojas</Text>
                        </Button>
                    </View>
                </Content>
