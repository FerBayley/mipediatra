...
class LiliTrivia26 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Los alimentos industrializados no son:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Nutritivos</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>Caseros</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Livianos</Text>
                        </Button>
                    </View>
                </Content>
