...
class LiliTrivia20 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        ¿Cuál de estos alimentos aporta menos potasio?
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Banana</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('LiliAdd20')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                        ...
                        >
                            <Text style={styles.blanco}>Papaya</Text>
                        </Button>
                    </View>
                </Content>
