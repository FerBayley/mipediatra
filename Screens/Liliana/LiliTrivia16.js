...
class LiliTrivia16 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Cuál de los siguientes alimentos no se clasifica como cereal:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Arroz</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>Trigo</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Sésaño</Text>
                        </Button>
                    </View>
                </Content>
