...
class LiliGanaste10 extends Component {    
    ...
    render() {
        ...
        const liliana = '../../assets/images/sorteo-liliana.png';
           ...
           <Content  showsVerticalScrollIndicator={false}>
               ...
               <View style={styles.container2}>
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <BlurView>
                            <Image style={{ width: 243, height: 276 }}
                            source={require( liliana )} />
                        </BlurView>
                    </View>

                    <Button block style={ styles.botonSegui }
                        onPress={() => this.props.navigation.navigate('BrandLiliana10')}
                    >
