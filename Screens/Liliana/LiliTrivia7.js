...
class LiliTrivia7 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('LiliAdd7')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>Una fruta</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>Una verduda</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Una hortaliza</Text>
                        </Button>
                    </View>
                </Content>
