...
class LiliTrivia25 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Un alimento es una sustancia ingerida principalmente con fines:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Lúdicos</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>Nutricionales</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Prácticos</Text>
                        </Button>
                    </View>
                </Content>
