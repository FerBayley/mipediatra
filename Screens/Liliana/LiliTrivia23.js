...
class LiliTrivia23 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Se denomina desayuno al alimento que:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Se consume durante la mañana</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('LiliAdd23')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Es el primero que se consume a primera hora del día</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Contiene lacteos y harinas</Text>
                        </Button>
                    </View>
                </Content>
