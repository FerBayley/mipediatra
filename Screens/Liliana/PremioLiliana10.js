...
class PremioLiliana10 extends Component {
    ...
    render() {
        ...
        const logoliliana = '../../assets/images/liliana-logopremio.png';
        const premioLiliana = '../../assets/images/sorteo-liliana.png';
            ...
            <Container>
                ...
                <Content showsVerticalScrollIndicator={false} style={styles.container}>
                    ...
                    <View style={styles.addProducto}>
                        ...
                        <BlurView>
                            <Image
                                style={{width: 199, height: 61, marginTop: 20}}
                                source={require( logoliliana )} />
                        </BlurView>


                        <BlurView>
                            <Image
                                style={{width: 340, height: 266, marginTop: 20}}
                                source={require( premioLiliana )} />
                        </BlurView>
                    </View>
                </Content>
                ...
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        <Button
                        onPress={() => this.props.navigation.navigate('LiliTrivia10')}>
...
export default PremioLiliana10;