...
class BabyjoggerMore2 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                     <View style={styles.logo}>
                        ...
                        <Text style={styles.textoPregunta}>
                            El Baby Jogger City Tour viene plegado en:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            <Text style={styles.blanco}>Una valija</Text>
                        </Button>

                        <Button full style={styles.btnB}>
                            {/* Respuesta Correcta*/}
                            <Text style={styles.blanco}>Una mochila</Text>
                        </Button>

                        <Button full style={styles.btnC}>
                            <Text style={styles.blanco}>Un carrito</Text>
                        </Button>
                    </View>
...
export default BabyjoggerMore2;