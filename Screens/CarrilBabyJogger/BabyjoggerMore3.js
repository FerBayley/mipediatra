...
class BabyjoggerMore3 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                     <View style={styles.logo}>
                        ...
                        <Text style={styles.textoPregunta}>
                            El Baby Jogger Mini City Zip plegado mide:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            ...
                            <Text style={styles.blanco}>75x36x32cm</Text>
                        </Button>

                        <Button full style={styles.btnB}>
                            <Text style={styles.blanco}>85x26x38cm</Text>
                        </Button>

                        <Button full style={styles.btnC}>
                            {/* Respuesta Correcta*/}
                            <Text style={styles.blanco}>75x26x32cm</Text>
                        </Button>
                    </View>
...
export default BabyjoggerMore3;