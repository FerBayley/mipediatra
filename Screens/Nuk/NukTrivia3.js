...
class NukTrivia3 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            ¿Con qué frecuencia debo reemplazar un chupete con tetina de latex?
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>Cada 3-4 meses</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Cada 5-6 meses</Text>
                        </Button>
                    </View>
                </Content>
