...
class NukTrivia24 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La leche materna puede conservarse en el freezer por:
                        </Text>
                    </View>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('NukAdd24')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
