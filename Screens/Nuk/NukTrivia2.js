...
class NukTrivia2 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            Los chupetes y tetinas NUK son ortodónticos porque promueven:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('NukAdd2')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>El uso de ortodoncia</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>La higiene bucal</Text>
                        </Button>
                    </View>
                </Content>
