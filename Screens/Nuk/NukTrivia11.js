...
class NukTrivia11 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Está comprobado que cuanto más sepas de lactancia materna:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('NukAdd11')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Mayor es la preparación para amamantar</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>Antes iniciás el destete</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Usás sacaleches</Text>
                        </Button>
                    </View>
                </Content>
