...
class TriviaPritt10 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                        ...
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('PrittAddError4')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                        ...
                        <Button full style={styles.btnB}
                             onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('PrittAdd10')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('PrittAddError4')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                ...
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate('BrandPritt22')}>
