...
class PrittAddError2 extends Component {    
    ...
    render() {
        ...
        const add1 ='../../assets/images/pritt-add2.png';
               ...
               <Container style={styles.container}>
                ...
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate('TriviaPritt7')}>
