...
class PrittAddError3 extends Component {    
    ...
    render() {
        ...
        const add1 ='../../assets/images/pritt-add3.png';
               ...
               <Container style={styles.container}>
                ...
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate('TriviaPritt10')}>
