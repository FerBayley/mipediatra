...
class TriviaEstrella26 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        El envase de las toallitas húmedas Estrella Baby con Manteca de Karité es:
                        </Text>
                    </View>
                        ...
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('EstrellaAdd26')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('Triviaestrella1')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
...
export default TriviaEstrella26;