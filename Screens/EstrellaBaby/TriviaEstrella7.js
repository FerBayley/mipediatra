            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            Según la lactancia materna a demanda, el bebé toma el pecho:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('EstrellaAdd7')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>cada vez que lo pide</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>cada 2 horas</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>cada hora</Text>
                        </Button>
                    </View>
                </Content>
