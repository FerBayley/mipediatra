...
class TriviaEstrella21 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Los masajes son benficiosos para el bebé desde:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Que nace</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>Los 30 días</Text>
                        </Button>
                ...
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate('EstrellaBrand4')}>
...
export default TriviaEstrella21;