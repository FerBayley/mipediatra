...
class TriviaEstrella22 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Según la talla recomendada por Estrella Baby, un bebé de 10Kg debe usar…
                        </Text>
                    </View>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('EstrellaAdd22')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
...
export default TriviaEstrella22;