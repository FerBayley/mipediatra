...
class TriviaJogger4 extends Component {
            ...
            <Container>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View style={styles.logo}>
                        ...
                        <Text style={styles.textoPregunta}>
                            Las 3 ciudades Europeas consideradas Family-Friendly son:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Amsterdam, Edimburgo y Dublin</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>París, Londres, Canberra</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Sídney, Viena, Barcelona</Text>
                        </Button>
                    </View>
                </Content>
