...
class TriviaJogger6 extends Component {
            ...
            <Container>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View style={styles.logo}>
                        ...
                        <Text style={styles.textoPregunta}>
                            Las ciudades europeas más recomendadas para recorrer a pie con niños, son:  
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Supai, Oymyakon y Tristan de Acuña</Text>
                        </Button>

                        <Button full style={styles.btnB}
                            onPress={() => this.props.navigation.navigate('null')}
                        >
                            <Text style={styles.blanco}>París, Florencia y Dubrovnik </Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Florida, Miami, El Salvador</Text>
                        </Button>
                    </View>
                </Content>
