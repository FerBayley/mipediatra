...
class TriviaJogger5 extends Component {
            ...
            <Container>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View style={styles.logo}>
                        ...
                        <Text style={styles.textoPregunta}>
                            En qué ciudad española se encuentra el Museo del Prado:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Madrid</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Barcelona</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Valencia</Text>
                        </Button>
                    </View>
                </Content>
