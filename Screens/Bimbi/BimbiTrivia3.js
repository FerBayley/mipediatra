...
class BimbiTrivia3 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            La capacidad muscular para rolar, se adquiere alrededor de los:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>1-2 meses</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>3-4 meses</Text>
                        </Button>
