...
class BimbiTrivia8 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Diversión, entretenimiento y destreza</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Creatividad, reglas e imaginación</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('BimbiAdd8')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
