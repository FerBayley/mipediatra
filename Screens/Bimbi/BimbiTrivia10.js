...
class BimbiTrivia10 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La etapa de desarrollo caracterizada por llevarse objetos a la boca, se denomina:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Etapa Oral</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Etapa Vocal</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            ...
                            >
                            <Text style={styles.blanco}>Etapa Fálica</Text>
                        </Button>
                    </View>
                </Content>
