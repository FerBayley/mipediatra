...
class BimbiTrivia18 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Los juguetes de encastre estimulan en desarrollo de:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>El orden y la organización</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>La creatividad y coordinación</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('BimbiAdd18')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
