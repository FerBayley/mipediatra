...
class BimbiTrivia23 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        En el equilibrio intervienen funciones de motricidad:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('BimbiAdd23')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>Gruesa</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Fina </Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            ...
                            >
                            <Text style={styles.blanco}>Amplia</Text>
                        </Button>
                    </View>
                </Content>
