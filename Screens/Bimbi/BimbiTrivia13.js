...
class BimbiTrivia13 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Cuando los niños juegan en simultáneo pero cada uno sin involucarar al otro, se clasifica como:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('BimbiAdd13')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>Juego Simultáneo</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Juego Espectador</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            ...
                            >
                            <Text style={styles.blanco}>Juego de Imitación</Text>
                        </Button>
                    </View>
                </Content>
