...
class BimbiTrivia5 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            El movimiento coordinado de gateo implica mover en simultáneo:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Pierna  y brazo del mismo lateral</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Ambas piernas</Text>
                        </Button>
                    </View>
                </Content>
