...
class BimbiTrivia19 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La estilulación temprana sugiere brindarle al bebé un entorno rico en:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Estímulos</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Juguetes</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            ...
                            >
                            <Text style={styles.blanco}>Personas</Text>
                        </Button>
                    </View>
                </Content>
