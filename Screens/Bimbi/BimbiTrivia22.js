...
class BimbiTrivia22 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        El bebé empieza a tomar conciencia que es otro ser- y no parte de su mamá- alrdededor de:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Los 3 meses</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Los 6 meses</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('BimbiAdd22')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Los 9 meses</Text>
                        </Button>
                    </View>
                </Content>
