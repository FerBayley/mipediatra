...
class TriviaGraco21 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La Graco Forever Extend2fit te permite llevar a tu hijo más tiempo mirando hacia atrás
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Hasta un peso de 12kg.</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Hasta un peso de 18kg.</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('GracoAdd21')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Hasta un peso de 22kg.</Text>
                        </Button>
                    </View>
                </Content>
