...
class TriviaGraco26 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La Graco SNUGGLE SUITE PIERCE es
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Cuna, corralito y napper desmontable con capota y vibración</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Cuna y corralito plegables</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            ...
                            >
                            <Text style={styles.blanco}>Napper con capota y vibración</Text>
                        </Button>
                    </View>
                </Content>
