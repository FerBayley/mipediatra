...
class TriviaGraco9 extends Component {
                        ...
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('GracoAddError3')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('GracoAdd9')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
