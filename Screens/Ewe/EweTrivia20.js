...
class EweTrivia20 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La capa grasosa protectora que posee  la piel del bebé al nacer se denomina:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Vérnix caseoso</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('AddEwe20')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Líquido Amniótico</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Capa Córnea</Text>
                        </Button>
                    </View>
                </Content>
