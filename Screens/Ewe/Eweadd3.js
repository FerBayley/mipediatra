...
class Ewedd3 extends Component {    
            ...
            <Container style={styles.container}>
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.imagenPauta}>
                       <TouchableOpacity onPress={() => this.props.navigation.navigate('BrandScreen')}>
                        <Image
                            style={{width: 288, height: 556}}
                            source={{uri: 'http://ideaswhite.com/mipediatra/clientes/ewe/ads/ewe3.png'}}
                        />
                       </TouchableOpacity>
                    </View>                    
                </Content>
