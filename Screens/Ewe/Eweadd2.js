...
class Ewedd2 extends Component {    
            ...
            <Container style={styles.container}>
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.imagenPauta}>
                       <TouchableOpacity onPress={() => this.props.navigation.navigate('TriviaEwe3')}>
                        <Image
                            style={{width: 288, height: 556}}
                            source={{uri: 'http://ideaswhite.com/mipediatra/clientes/ewe/ads/ewe2.png'}}
                        />
                       </TouchableOpacity>
                    </View>                    
                </Content>
                ...
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate('TriviaEwe3')}>
