...
class EweTrivia16 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        El Óle Calcáreo Ewe de 500ml. rinde como:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>100 toallitas húmedas</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('AddEwe16')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>250 toallitas húmedas</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>1000 toallitas húmedas</Text>
                        </Button>
                    </View>
                </Content>
