...
class EweTrivia21 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Las frecuentes erupciones cutáneas del bebé causadas por sudoración se denominan:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('AddEwe21')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>Sudaminas</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Sebáceas</Text>
                        </Button>
                    </View>
                </Content>
