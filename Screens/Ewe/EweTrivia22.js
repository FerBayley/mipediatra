...
class EweTrivia22 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Las causas de la dermatitis de pañal, se relacionan con el contacto de la piel del bebé con:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Heces y orina</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('AddEweError7')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>El roce del pañal</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('AddEwe22')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                ...
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate('EweBrand13')}>
