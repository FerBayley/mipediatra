...
class EweTrivia13 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        Si el bebé tiene las uñas largas, lo más conveniente es:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Ponerle guantes</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Avanzar', onPress: () => this.props.navigation.navigate('AddEwe13')}
                                    ],
                                    { cancelable: false }
                                  )}
                            >
                            <Text style={styles.blanco}>Limarlas</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Cortarlas</Text>
                        </Button>
                    </View>
                </Content>
