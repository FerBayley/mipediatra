...
class TriviaSilfab6 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            Si los padres padecen hipertensión, el riesgo de los hijos de padecer esta enfermedad es:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Menor al 50%</Text>
                        </Button>
                    </View>
                </Content>
