...
class TriviaSilfab12 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        En los recién nacidos, se recomienda tomar la temperatura:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>anal</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                    {text: 'Avanzar', onPress: () => this.props.navigation.navigate('SilfabAdd12')}
                                    ],
                                    { cancelable: false }
                                )}
                            >
                            <Text style={styles.blanco}>axilar</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>oral</Text>
                        </Button>
                    </View>
                </Content>
