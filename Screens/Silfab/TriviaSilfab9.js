...
class TriviaSilfab9 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            La OMS y el Ministerio de Salud de la Nación mediante la Resolución 139/2009 promueven eliminar los termómetros:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Digitales</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                    {text: 'Avanzar', onPress: () => this.props.navigation.navigate('SilfabAdd9')}
                                    ],
                                    { cancelable: false }
                                )}
                            >
                            <Text style={styles.blanco}>De mercurio</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>De pilas</Text>
                        </Button>
                    </View>
                </Content>
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate('BrandSilfab13')}>
