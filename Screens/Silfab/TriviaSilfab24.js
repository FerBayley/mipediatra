...
class TriviaSilfab24 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>peso (kg) /altura (m) * altura (m)</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>peso (kg) /altura (cm) * altura (cm)</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>peso (kg) /altura (m) * 2</Text>
                        </Button>
                    </View>
                </Content>
