...
class TriviaSilfab14 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La principal causa de las enfermedades respiratorias crónicas es:
                        </Text>
                    </View>
                        ...
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('SilfabAdd14')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>El tabaquismo</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                    {text: 'Avanzar', onPress: () => this.props.navigation.navigate('SilfabAddError5')}
                                    ],
                                    { cancelable: false }
                                )}
                            >
                            <Text style={styles.blanco}>Antecedentes familiares</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnC}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('SilfabAddError5')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                            <Text style={styles.blanco}>Contaminación ambiental</Text>
                        </Button>
                    </View>
                </Content>
                <Footer style={styles.Pie}>
                    <FooterTab style={styles.Pie}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate('BrandSilfab25')}>
