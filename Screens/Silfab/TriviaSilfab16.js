...
class TriviaSilfab16 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>Crónica</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            ...
                            >
                            <Text style={styles.blanco}>Temporaria</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>Contagiosa</Text>
                        </Button>
                    </View>
                </Content>
