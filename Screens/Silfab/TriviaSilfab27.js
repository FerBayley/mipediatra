...
class TriviaSilfab27 extends Component {
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        La tensión arterial normal em adultos es:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        ...
                        >
                            <Text style={styles.blanco}>110 mm Hg- 70 mm Hg</Text>
                        </Button>
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                    {text: 'Avanzar', onPress: () => this.props.navigation.navigate('SilfabAdd27')}
                                    ],
                                    { cancelable: false }
                                )}
                            >
                            <Text style={styles.blanco}>120 mm Hg- 80 mm Hg</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>120 mm Hg- 90 mm Hg</Text>
                        </Button>
                    </View>
                </Content>
