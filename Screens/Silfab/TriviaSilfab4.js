...
class TriviaSilfab4 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            La cantidad normal de respiraciones por minuto de un bebé entre 1 y 24 meses es:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                      {text: 'Seguí participando', onPress: () => this.props.navigation.navigate('SilfabAddError2')}
                                    ],
                                    { cancelable: false }
                                  )}
                        >
                        ...
                        <Button full style={styles.btnB}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                    {text: 'Avanzar', onPress: () => this.props.navigation.navigate('SilfabAdd4')}
                                    ],
                                    { cancelable: false }
                                )}
                            >
                        ...
                        >
                            <Text style={styles.blanco}>40-50</Text>
                        </Button>
                    </View>
                </Content>
