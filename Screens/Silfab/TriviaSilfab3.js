...
class TriviaSilfab3 extends Component {
            ...
            <Container style={{ backgroundColor: '#FFF' }}>
                ...
                <Content showsVerticalScrollIndicator={false}>
                    <View>
                     ...
                     <View>
                        ...
                        <Text style={styles.textoPregunta}>
                            Los termómetros Silfab están avalados en Argentina por el:
                        </Text>
                    </View>
                    ...
                    <View style={styles.contenedorBtn}>
                        <Button full style={styles.btnA}
                            onPress={() =>
                                Alert.alert(
                                    ...
                                    '',
                                    [
                                    {text: 'Avanzar', onPress: () => this.props.navigation.navigate('SilfabAdd3')}
                                    ],
                                    { cancelable: false }
                                )}
                            >
                            <Text style={styles.blanco}>INTI Y ANMAT</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>AAMR</Text>
                        </Button>
                        ...
                        >
                            <Text style={styles.blanco}>AAP</Text>
                        </Button>
                    </View>
                </Content>
